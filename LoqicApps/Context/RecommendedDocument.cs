...
namespace CrmEarlyBound
{
	...
	public partial class RecommendedDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public CrmEarlyBound.SystemUser lk_recommendeddocument_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_recommendeddocument_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_recommendeddocument_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_recommendeddocument_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recommendeddocument_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_recommendeddocument_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_recommendeddocument", null);
			}
		}
		...
		public CrmEarlyBound.TransactionCurrency TransactionCurrency_recommendeddocument
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_recommendeddocument", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_recommendeddocument");
				this.SetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_recommendeddocument", null, value);
