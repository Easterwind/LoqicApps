...
namespace CrmEarlyBound
{
	...
	public partial class PostComment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.activityfileattachment> post_comment_activity_file_attachment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.activityfileattachment>("post_comment_activity_file_attachment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("post_comment_activity_file_attachment");
				this.SetRelatedEntities<CrmEarlyBound.activityfileattachment>("post_comment_activity_file_attachment", null, value);
		...
		public CrmEarlyBound.SystemUser lk_postcomment_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_postcomment_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_postcomment_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_postcomment_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_postcomment_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_postcomment_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_PostComment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_PostComment", null);
			}
		}
		...
		public CrmEarlyBound.Post Post_Comments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Post>("Post_Comments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntity<CrmEarlyBound.Post>("Post_Comments", null, value);
