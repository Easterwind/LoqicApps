...
namespace CrmEarlyBound
{
	...
	public partial class ActionCardUserState : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public CrmEarlyBound.ActionCard ActionCardUserState_ActionCard
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.ActionCard>("ActionCardUserState_ActionCard", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActionCardUserState_ActionCard");
				this.SetRelatedEntity<CrmEarlyBound.ActionCard>("ActionCardUserState_ActionCard", null, value);
		...
		public CrmEarlyBound.Owner ActionCardUserState_Owner
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Owner>("ActionCardUserState_Owner", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActionCardUserState_Owner");
				this.SetRelatedEntity<CrmEarlyBound.Owner>("ActionCardUserState_Owner", null, value);
		...
		public CrmEarlyBound.TransactionCurrency TransactionCurrency_ActionCardUserState
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_ActionCardUserState");
				this.SetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null, value);
