...
namespace CrmEarlyBound
{
	...
	public partial class ActivityParty : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.SyncError> ActivityParty_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.SyncError>("ActivityParty_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActivityParty_SyncErrors");
				this.SetRelatedEntities<CrmEarlyBound.SyncError>("ActivityParty_SyncErrors", null, value);
		...
		public CrmEarlyBound.adx_alertsubscription adx_alertsubscription_activity_parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.adx_alertsubscription>("adx_alertsubscription_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("adx_alertsubscription_activity_parties");
				this.SetRelatedEntity<CrmEarlyBound.adx_alertsubscription>("adx_alertsubscription_activity_parties", null, value);
		...
		public CrmEarlyBound.adx_inviteredemption adx_inviteredemption_activity_parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.adx_inviteredemption>("adx_inviteredemption_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("adx_inviteredemption_activity_parties");
				this.SetRelatedEntity<CrmEarlyBound.adx_inviteredemption>("adx_inviteredemption_activity_parties", null, value);
		...
		public CrmEarlyBound.adx_portalcomment adx_portalcomment_activity_parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.adx_portalcomment>("adx_portalcomment_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("adx_portalcomment_activity_parties");
				this.SetRelatedEntity<CrmEarlyBound.adx_portalcomment>("adx_portalcomment_activity_parties", null, value);
		...
		public CrmEarlyBound.chat chat_activity_parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.chat>("chat_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("chat_activity_parties");
				this.SetRelatedEntity<CrmEarlyBound.chat>("chat_activity_parties", null, value);
		...
		public CrmEarlyBound.Letter letter_activity_parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Letter>("letter_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("letter_activity_parties");
				this.SetRelatedEntity<CrmEarlyBound.Letter>("letter_activity_parties", null, value);
