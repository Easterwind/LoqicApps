...
namespace CrmEarlyBound
{
	...
	public partial class Post : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.activityfileattachment> post_activity_file_attachment
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.activityfileattachment>("post_activity_file_attachment", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("post_activity_file_attachment");
				this.SetRelatedEntities<CrmEarlyBound.activityfileattachment>("post_activity_file_attachment", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.BulkDeleteFailure> post_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.BulkDeleteFailure>("post_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("post_BulkDeleteFailures");
				this.SetRelatedEntities<CrmEarlyBound.BulkDeleteFailure>("post_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PostComment> Post_Comments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PostComment>("Post_Comments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntities<CrmEarlyBound.PostComment>("Post_Comments", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PostRole> postRole_Post
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PostRole>("postRole_Post", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("postRole_Post");
				this.SetRelatedEntities<CrmEarlyBound.PostRole>("postRole_Post", null, value);
		...
		public CrmEarlyBound.PostRegarding post_PostRegardings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.PostRegarding>("post_PostRegardings", null);
			}
		}
