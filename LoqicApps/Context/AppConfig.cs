...
namespace CrmEarlyBound
{
	...
	public partial class AppConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.AppConfigState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.AppConfigState)(System.Enum.ToObject(typeof(CrmEarlyBound.AppConfigState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.AppConfigInstance> appconfig_appconfiginstance
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.AppConfigInstance>("appconfig_appconfiginstance", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appconfig_appconfiginstance");
				this.SetRelatedEntities<CrmEarlyBound.AppConfigInstance>("appconfig_appconfiginstance", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.NavigationSetting> navigationsetting_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.NavigationSetting>("navigationsetting_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("navigationsetting_appconfig");
				this.SetRelatedEntities<CrmEarlyBound.NavigationSetting>("navigationsetting_appconfig", null, value);
		...
		public CrmEarlyBound.AppModule appmodule_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.AppModule>("appmodule_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appconfig");
				this.SetRelatedEntity<CrmEarlyBound.AppModule>("appmodule_appconfig", null, value);
		...
		public CrmEarlyBound.SystemUser lk_appconfig_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_appconfig_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_appconfig_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_appconfig_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appconfig_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_appconfig", null);
			}
		}
