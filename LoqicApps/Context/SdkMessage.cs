...
namespace CrmEarlyBound
{
	...
	public partial class SdkMessage : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.CustomAPI> sdkmessage_customapi
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.CustomAPI>("sdkmessage_customapi", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessage_customapi");
				this.SetRelatedEntities<CrmEarlyBound.CustomAPI>("sdkmessage_customapi", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.ServicePlanMapping> sdkmessage_serviceplanmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.ServicePlanMapping>("sdkmessage_serviceplanmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdkmessage_serviceplanmapping");
				this.SetRelatedEntities<CrmEarlyBound.ServicePlanMapping>("sdkmessage_serviceplanmapping", null, value);
