...
namespace CrmEarlyBound
{
	...
	public partial class KnowledgeSearchModel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.KnowledgeSearchModelState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.KnowledgeSearchModelState)(System.Enum.ToObject(typeof(CrmEarlyBound.KnowledgeSearchModelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.TextAnalyticsEntityMapping> knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public CrmEarlyBound.AzureServiceConnection azureserviceconnection_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_knowledgesearchmodel");
				this.SetRelatedEntity<CrmEarlyBound.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null, value);
		...
		public CrmEarlyBound.SystemUser lk_knowledgesearchmodel_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_knowledgesearchmodel_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_knowledgesearchmodel_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_knowledgesearchmodel_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_knowledgesearchmodel", null);
			}
		}
