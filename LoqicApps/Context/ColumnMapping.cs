...
namespace CrmEarlyBound
{
	...
	public partial class ColumnMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.ColumnMappingState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.ColumnMappingState)(System.Enum.ToObject(typeof(CrmEarlyBound.ColumnMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.LookUpMapping> LookUpMapping_ColumnMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.LookUpMapping>("LookUpMapping_ColumnMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("LookUpMapping_ColumnMapping");
				this.SetRelatedEntities<CrmEarlyBound.LookUpMapping>("LookUpMapping_ColumnMapping", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PickListMapping> PickListMapping_ColumnMapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PickListMapping>("PickListMapping_ColumnMapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("PickListMapping_ColumnMapping");
				this.SetRelatedEntities<CrmEarlyBound.PickListMapping>("PickListMapping_ColumnMapping", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.UserEntityInstanceData> userentityinstancedata_columnmapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_columnmapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_columnmapping");
				this.SetRelatedEntities<CrmEarlyBound.UserEntityInstanceData>("userentityinstancedata_columnmapping", null, value);
		...
		public CrmEarlyBound.ImportMap ColumnMapping_ImportMap
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.ImportMap>("ColumnMapping_ImportMap", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ColumnMapping_ImportMap");
				this.SetRelatedEntity<CrmEarlyBound.ImportMap>("ColumnMapping_ImportMap", null, value);
		...
		public CrmEarlyBound.SystemUser lk_columnmapping_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_columnmapping_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_columnmapping_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_columnmapping_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_columnmapping_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_columnmapping_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_columnmapping_modifiedonbehalfby", null, value);
