...
namespace CrmEarlyBound
{
	...
	public partial class CardType : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public virtual CardType_ClientAvailability? ClientAvailability
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.ActionCard> cardtype_actioncard
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.ActionCard>("cardtype_actioncard", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cardtype_actioncard");
				this.SetRelatedEntities<CrmEarlyBound.ActionCard>("cardtype_actioncard", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.ActionCardUserSettings> cardtype_actioncardusersettings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.ActionCardUserSettings>("cardtype_actioncardusersettings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cardtype_actioncardusersettings");
				this.SetRelatedEntities<CrmEarlyBound.ActionCardUserSettings>("cardtype_actioncardusersettings", null, value);
		...
		public CrmEarlyBound.SystemUser lk_cardtype_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_cardtype_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_cardtype_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_cardtype_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_cardtype_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_cardtype_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_cardtype_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.TransactionCurrency transactioncurrency_cardtype
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.TransactionCurrency>("transactioncurrency_cardtype", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("transactioncurrency_cardtype");
				this.SetRelatedEntity<CrmEarlyBound.TransactionCurrency>("transactioncurrency_cardtype", null, value);
