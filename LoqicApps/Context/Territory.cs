...
namespace CrmEarlyBound
{
	...
	public partial class Territory : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.BulkDeleteFailure> Territory_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.BulkDeleteFailure>("Territory_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Territory_BulkDeleteFailures");
				this.SetRelatedEntities<CrmEarlyBound.BulkDeleteFailure>("Territory_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.MailboxTrackingFolder> territory_MailboxTrackingFolders
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.MailboxTrackingFolder>("territory_MailboxTrackingFolders", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("territory_MailboxTrackingFolders");
				this.SetRelatedEntities<CrmEarlyBound.MailboxTrackingFolder>("territory_MailboxTrackingFolders", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.Territory> Referencedterritory_parent_territory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.Territory>("territory_parent_territory", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencedterritory_parent_territory");
				this.SetRelatedEntities<CrmEarlyBound.Territory>("territory_parent_territory", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.SyncError> Territory_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.SyncError>("Territory_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Territory_SyncErrors");
				this.SetRelatedEntities<CrmEarlyBound.SyncError>("Territory_SyncErrors", null, value);
		...
		public CrmEarlyBound.ImageDescriptor lk_territory_entityimage
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.ImageDescriptor>("lk_territory_entityimage", null);
			}
		}
		...
		public CrmEarlyBound.Territory Referencingterritory_parent_territory
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Territory>("territory_parent_territory", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencingterritory_parent_territory");
				this.SetRelatedEntity<CrmEarlyBound.Territory>("territory_parent_territory", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
