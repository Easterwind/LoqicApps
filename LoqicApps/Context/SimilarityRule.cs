...
namespace CrmEarlyBound
{
	...
	public partial class SimilarityRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.SimilarityRuleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.SimilarityRuleState)(System.Enum.ToObject(typeof(CrmEarlyBound.SimilarityRuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.AsyncOperation> similarityrule_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.AsyncOperation>("similarityrule_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_AsyncOperations");
				this.SetRelatedEntities<CrmEarlyBound.AsyncOperation>("similarityrule_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.TextAnalyticsEntityMapping> similarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("similarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_textanalyticsentitymapping");
				this.SetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("similarityrule_textanalyticsentitymapping", null, value);
		...
		public CrmEarlyBound.SystemUser lk_similarityrule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_similarityrule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_similarityrule_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_similarityrule_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_similarityrule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_similarityrule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_similarityrule_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_similarityrule_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_similarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_similarityrule", null);
			}
		}
		...
		public CrmEarlyBound.TransactionCurrency TransactionCurrency_SimilarityRule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_SimilarityRule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_SimilarityRule");
				this.SetRelatedEntity<CrmEarlyBound.TransactionCurrency>("TransactionCurrency_SimilarityRule", null, value);
