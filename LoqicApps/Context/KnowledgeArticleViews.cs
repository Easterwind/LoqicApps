...
namespace CrmEarlyBound
{
	...
	public partial class KnowledgeArticleViews : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.KnowledgeArticleViewsState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.KnowledgeArticleViewsState)(System.Enum.ToObject(typeof(CrmEarlyBound.KnowledgeArticleViewsState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.PrincipalObjectAttributeAccess> knowledgearticleview_principalobjectattributeaccess
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticleview_principalobjectattributeaccess");
				this.SetRelatedEntities<CrmEarlyBound.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.SyncError> KnowledgeArticleViews_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.SyncError>("KnowledgeArticleViews_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeArticleViews_SyncErrors");
				this.SetRelatedEntities<CrmEarlyBound.SyncError>("KnowledgeArticleViews_SyncErrors", null, value);
		...
		public CrmEarlyBound.KnowledgeArticle knowledgearticle_views
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.KnowledgeArticle>("knowledgearticle_views", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_views");
				this.SetRelatedEntity<CrmEarlyBound.KnowledgeArticle>("knowledgearticle_views", null, value);
		...
		public CrmEarlyBound.SystemUser lk_knowledgearticleviews_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_knowledgearticleviews_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_knowledgearticleviews_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_knowledgearticleviews_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.TransactionCurrency transactioncurrency_knowledgearticleviews
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.TransactionCurrency>("transactioncurrency_knowledgearticleviews", null);
			}
		}
