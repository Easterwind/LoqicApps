...
namespace CrmEarlyBound
{
	...
	public partial class TextAnalyticsEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public virtual TextAnalyticsEntityMapping_EntityPickList? EntityPickList
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		public virtual TextAnalyticsEntityMapping_FieldPickList? FieldPickList
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		public CrmEarlyBound.AdvancedSimilarityRule advancedsimilarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("advancedsimilarityrule_textanalyticsentitymapping");
				this.SetRelatedEntity<CrmEarlyBound.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null, value);
		...
		public CrmEarlyBound.KnowledgeSearchModel knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntity<CrmEarlyBound.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public CrmEarlyBound.SimilarityRule similarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SimilarityRule>("similarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("similarityrule_textanalyticsentitymapping");
				this.SetRelatedEntity<CrmEarlyBound.SimilarityRule>("similarityrule_textanalyticsentitymapping", null, value);
