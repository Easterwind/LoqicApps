...
namespace CrmEarlyBound
{
	...
	public partial class AdvancedSimilarityRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.AdvancedSimilarityRuleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.AdvancedSimilarityRuleState)(System.Enum.ToObject(typeof(CrmEarlyBound.AdvancedSimilarityRuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.TextAnalyticsEntityMapping> advancedsimilarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("advancedsimilarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("advancedsimilarityrule_textanalyticsentitymapping");
				this.SetRelatedEntities<CrmEarlyBound.TextAnalyticsEntityMapping>("advancedsimilarityrule_textanalyticsentitymapping", null, value);
		...
		public CrmEarlyBound.AzureServiceConnection azureserviceconnection_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.AzureServiceConnection>("azureserviceconnection_advancedsimilarityrule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_advancedsimilarityrule");
				this.SetRelatedEntity<CrmEarlyBound.AzureServiceConnection>("azureserviceconnection_advancedsimilarityrule", null, value);
		...
		public CrmEarlyBound.SystemUser lk_advancedsimilarityrule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_advancedsimilarityrule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_advancedsimilarityrule_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_advancedsimilarityrule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_advancedsimilarityrule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_advancedsimilarityrule_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_advancedsimilarityrule", null);
			}
		}
