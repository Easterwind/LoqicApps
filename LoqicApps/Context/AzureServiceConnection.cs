...
namespace CrmEarlyBound
{
	...
	public partial class AzureServiceConnection : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CrmEarlyBound.AzureServiceConnectionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CrmEarlyBound.AzureServiceConnectionState)(System.Enum.ToObject(typeof(CrmEarlyBound.AzureServiceConnectionState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.AdvancedSimilarityRule> azureserviceconnection_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.AdvancedSimilarityRule>("azureserviceconnection_advancedsimilarityrule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_advancedsimilarityrule");
				this.SetRelatedEntities<CrmEarlyBound.AdvancedSimilarityRule>("azureserviceconnection_advancedsimilarityrule", null, value);
		...
		public System.Collections.Generic.IEnumerable<CrmEarlyBound.KnowledgeSearchModel> azureserviceconnection_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<CrmEarlyBound.KnowledgeSearchModel>("azureserviceconnection_knowledgesearchmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_knowledgesearchmodel");
				this.SetRelatedEntities<CrmEarlyBound.KnowledgeSearchModel>("azureserviceconnection_knowledgesearchmodel", null, value);
		...
		public CrmEarlyBound.SystemUser lk_azureserviceconnection_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_azureserviceconnection_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_azureserviceconnection_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_azureserviceconnection_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_azureserviceconnection_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_azureserviceconnection_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_azureserviceconnection_modifiedonbehalfby", null, value);
		...
		public CrmEarlyBound.Organization organization_azureserviceconnection
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.Organization>("organization_azureserviceconnection", null);
			}
		}
