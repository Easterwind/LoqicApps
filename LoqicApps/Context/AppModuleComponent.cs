...
namespace CrmEarlyBound
{
	...
	public partial class AppModuleComponent : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public CrmEarlyBound.AppModule appmodule_appmodulecomponent
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.AppModule>("appmodule_appmodulecomponent", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appmodulecomponent");
				this.SetRelatedEntity<CrmEarlyBound.AppModule>("appmodule_appmodulecomponent", null, value);
		...
		public CrmEarlyBound.SystemUser lk_appmodulecomponent_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_createdby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_appmodulecomponent_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodulecomponent_createdonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_createdonbehalfby", null, value);
		...
		public CrmEarlyBound.SystemUser lk_appmodulecomponent_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_modifiedby", null);
			}
		}
		...
		public CrmEarlyBound.SystemUser lk_appmodulecomponent_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appmodulecomponent_modifiedonbehalfby");
				this.SetRelatedEntity<CrmEarlyBound.SystemUser>("lk_appmodulecomponent_modifiedonbehalfby", null, value);
