...
namespace LogiqApps.CustomEntity
{
    internal static class CustomEntityExtensions
    {
        public static EntityCollection ToCustomEntityCollection(this EntityCollection entityCollection, List<OptionSetOptionResponseParams> optionsList = null)
        {
            ...
            var customEntities = new List<LogiqApps.CustomEntity.CustomEntity>();
            foreach (var entity in entities)
            {
                var customEntity = new LogiqApps.CustomEntity.CustomEntity()
                {
                    Id = entity.Id,
            ...
            return ToCustomEntityCollection(jsonResult);
        }
